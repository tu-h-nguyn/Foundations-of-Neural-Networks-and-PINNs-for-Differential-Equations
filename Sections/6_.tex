...
như hoàn toàn đến từ cấu hình mạng, số điểm phối trí và độ dài L-BFGS; lấy mẫu
thích nghi chỉ cải thiện sai số \emph{cục bộ} tại lớp sốc.
...
thử các biến thể lấy mẫu thích nghi \emph{lấy mẫu lại toàn bộ} tập điểm theo
$\abs{r}$ --- vì Mục~\ref{subsec:tn10-tachbien} cho thấy RAR dạng \emph{thêm
điểm} đổi sai số ở lớp sốc lấy sai số ở vùng trơn, và một biến thể giữ mật độ
điểm trên vùng trơn có thể tránh được sự đánh đổi ấy;
