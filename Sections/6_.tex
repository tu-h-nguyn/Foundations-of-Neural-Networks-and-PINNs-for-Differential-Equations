...
một thí nghiệm tách biến cho Mục~\ref{sec:tn10} --- cùng cấu hình, bỏ RAR --- để
đo vai trò riêng của lấy mẫu thích nghi, vốn hiện chưa tách được khỏi ba thay đổi
đi kèm (Nhận xét~\ref{nx:khong-quy-cong-rar});
