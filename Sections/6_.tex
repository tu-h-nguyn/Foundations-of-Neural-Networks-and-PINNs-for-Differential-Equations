...
Mục~\ref{sec:tn11} là thí nghiệm duy nhất đặt PINN vào một trong ba động lực kể
trên --- bài toán ngược với điều kiện đầu và biên khuyết --- và cho nó một đối thủ
cổ điển được cho cùng thông tin. PINN tìm được độ nhớt với sai số trung vị dưới
$0{,}5\%$ ở cả hai mức nhiễu, không cần điều kiện đầu hay biên. Phương pháp liên
hợp rời rạc cũng làm được điều đó, với độ chính xác cùng bậc và nhanh hơn tới khi
có đáp số; cái nó cần thêm là $133$ dòng mã liên hợp phải tự suy ra và kiểm
chứng. Ưu thế của PINN ở động lực thứ nhất vì vậy là ưu thế về công sức, và việc
nó quyết định hay không tuỳ vào việc viết bộ giải liên hợp cho bài toán đang xét
khó tới đâu (Nhận xét~\ref{nx:doc-tn11}).
...
đáng chú ý: trong mười sáu hạng mục, \emph{không} một mệnh đề đã chứng minh nào
bị số liệu bác bỏ. Cả chín hạng mục phải điều chỉnh đều đến từ bốn kiểu suy luận
yếu hơn --- đối chiếu một số mũ đo ở ngân sách hữu hạn với số mũ tiệm cận, ghép
hai kết quả rời rạc, khái quát hoá từ một lần chạy duy nhất, và phát biểu định
lượng hay so sánh chưa từng được đo.

Bên cạnh ba đóng góp đã dự kiến, quá trình thực nghiệm sinh thêm sáu kết quả
không nằm trong kế hoạch ban đầu, và cả sáu đều xuất phát từ \emph{kết quả tiêu
cực}:
...
\item \textbf{Hai phát biểu về bài toán ngược được đặt đúng chỗ.}
      Mục~\ref{sec:tn11} đặt PINN cạnh một phương pháp liên hợp rời rạc được cho
      cùng thông tin. Chương~\ref{chap:pinn} từng gọi cách làm của PINN là ``ưu
      thế nổi bật''; số đo cho thấy ưu thế ấy có thật nhưng nằm ở công sức xây
      dựng --- bảy dòng mã so với $133$ --- còn về độ chính xác thì ngang ngửa, về
      thời gian tới đáp số thì phương pháp liên hợp nhanh hơn
      (Nhận xét~\ref{nx:doc-tn11}). Câu ``sai số $\zeta_2$ luôn lớn hơn sai số
      $\zeta_1$ khoảng một bậc'' cũng chỉ đúng ở tám trên mười lần chạy. Cả hai
      đều là phát biểu mà báo cáo tiếp nhận từ tài liệu và chưa từng tự kiểm.
\end{itemize}
...
thẳng kết nối đầy đủ, gần như chỉ bài toán thuận --- bài toán ngược xuất hiện
đúng một lần, với hai tham số vô hướng --- và chỉ các phương trình một chiều theo
...
nhưng nối liền với nó: bài toán ngược mà tham số là một \emph{hàm} --- chẳng hạn
hệ số nhớt $\nu(x)$ --- nơi Mục~\ref{sec:tn11} chỉ mới thử với hai số vô hướng, và
nơi cả PINN lẫn phương pháp liên hợp đều có chi phí gradient không phụ thuộc số
ẩn, nên phép so sánh sẽ xoay quanh điều kiện chỉnh hoá chứ không quanh chi phí;
và bài toán nhiều chiều, nơi lập luận chống lời
