...
riêng, thuật toán mới và mã nguồn phức tạp. Chi phí có thể ở mức không chấp nhận
được, vì mỗi bước lặp của bài toán ngược lại đòi hỏi giải trọn vẹn một bài toán
thuận --- dù Mục~\ref{sec:tn11} sẽ cho thấy ở bài toán một chiều, nơi một lần giải
thuận chỉ tốn chưa tới một giây, cái giá thật nằm ở công sức viết mã hơn là ở
thời gian chạy.
...
trực tiếp các phương pháp truyền thống là bất khả thi --- muốn dùng chúng, phải coi
chính các điều kiện ấy là ẩn số của một bài toán tối ưu, như
Mục~\ref{sec:tn11} làm.
...
Về \emph{lớp bài toán}, trọng tâm đặt vào bài toán thuận; bài toán ngược được
trình bày ở mức tổng quan (Mục~\ref{subsec:thuan-nguoc}) nhằm cho thấy tính thống
nhất của khung phương pháp, và được thực nghiệm đúng một lần
(Mục~\ref{sec:tn11}).
...
kiểm chứng bằng mười một thí nghiệm, mỗi thí nghiệm trả lời một câu hỏi cụ thể với tiêu
