...
đầy đủ cả những chỗ khớp lẫn những chỗ không khớp: trong mười sáu hạng mục đối
chiếu ở Mục~\ref{sec:doi-chieu}, sáu khớp trọn vẹn, hai khớp về hướng nhưng
không về độ lớn, \emph{sáu} buộc phải siết lại cách phát biểu, một không tái lập
...
Mục~\ref{sec:tn1}--\ref{sec:tn11} trình bày mười một thí nghiệm: mười bài toán
thuận, và một bài toán ngược đặt cạnh một phương pháp cổ điển được cho cùng thông
tin.
...
(Mục~\ref{subsec:thuan-nguoc}). Lợi thế thứ ba về sau đã được đo, ở
Mục~\ref{sec:tn11}: nó có thật, nhưng là lợi thế về công sức xây dựng phương pháp
chứ không về chi phí tính toán (Nhận xét~\ref{nx:doc-tn11}).
...
\textbf{Kết quả 3: sai số vẫn đậm đặc nhất ở lớp sốc, nhưng chỉ còn khoảng một
nửa sai số $L^2$ nằm ở đó.} Tỉ số $\varepsilon_{L^\infty}/\varepsilon_{L^2}$ gần
như không đổi --- khoảng $15$ ở Mục~\ref{sec:tn5}, khoảng $13$ ở TN10 --- và ở
\emph{cả năm} hạt giống, điểm sai số lớn nhất nằm trong dải $\abs{x} < 0{,}02$
sau thời điểm hình thành sốc $t_b = 1/\pi$. Dải ấy chỉ chiếm $1{,}4\%$ diện tích
miền nhưng chứa trung vị $51\%$ tổng bình phương sai số, khoảng
$[12\%;\ 63\%]$ --- tức đậm đặc gấp khoảng $36$ lần mức trung bình. Ngoài dải,
sai số lớn nhất có trung vị $1{,}64\times10^{-3}$ và sai số điển hình (trung vị
theo điểm) chỉ $1{,}4\times10^{-4}$.

Khoảng $[12\%;\ 63\%]$ rộng, và cần nói rõ rằng hạt giống trung vị theo
$\varepsilon_{L^2}$ --- hạt giống $1$, vẽ ở Hình~\ref{fig:tn10}(b) --- lại chính
là hạt giống có phần trong dải \emph{nhỏ nhất}; hình ấy vì vậy cho ấn tượng sai
số trải đều hơn thực tế. Kết luận đọc được trên cả năm hạt giống là: sau TN10,
$\varepsilon_{L^2}$ đến từ hai nguồn có độ lớn cùng bậc --- lớp sốc và mức nền
$10^{-4}$ trên vùng trơn --- nên muốn hạ nó thêm phải xử lý \emph{cả hai}, không
chỉ lớp sốc như bức tranh của TN5 gợi ý.
...
Câu hỏi còn lại --- trong hệ số $2{,}4$ của năm đợt sau, bao nhiêu là của RAR
--- được trả lời bằng thí nghiệm tách biến ở
Mục~\ref{subsec:tn10-tachbien}: rất ít, và không nhất quán giữa các hạt giống.
\end{nhanxet}
...
\subsection{Tách biến: vai trò riêng của RAR}
\label{subsec:tn10-tachbien}

\textbf{Thiết kế.} Giữ nguyên \emph{mọi thứ} của TN10 và chỉ đổi cách thêm điểm
phối trí. Ba nhánh rẽ ra từ \emph{cùng} một trạng thái --- trọng số và tập điểm
sau Adam và đợt L-BFGS thứ nhất, đúng thời điểm RAR bắt đầu can thiệp --- nên
khác biệt giữa chúng chỉ đến từ năm đợt L-BFGS sau:
\begin{itemize}[leftmargin=2.2em,itemsep=2pt]
\item \emph{RAR}: như TN10, sau đợt $1$--$3$ thêm $500$ điểm có $\abs{r}$ lớn
  nhất trong $20\,000$ ứng viên;
\item \emph{ngẫu nhiên}: sau đợt $1$--$3$ thêm $500$ điểm rải \emph{đều} ---
  cùng \emph{số} điểm như RAR, chỉ khác \emph{vị trí}, để tách ``thích nghi''
  khỏi ``nhiều điểm hơn'';
\item \emph{không thêm}: $N_r = 10\,000$ tới hết.
\end{itemize}
Nhánh RAR là một phép kiểm chứng: nó phải cho lại đúng TN10. Trên cả năm hạt
giống, $\varepsilon_{L^2}$ cuối của nhánh này trùng TN10 \emph{từng bit}.

\begin{table}[H]
\centering
\caption[Tách biến vai trò của RAR]{Thí nghiệm tách biến trên năm hạt giống:
trung vị và khoảng. Cột ``thắng'' đếm số hạt giống mà RAR tốt hơn nhánh ấy
\emph{trên cùng hạt giống}. Dải sốc là $\abs{x} < 0{,}02$, $t > 1/\pi$, chiếm
$1{,}4\%$ diện tích miền.}
\label{tab:tn10b}
\footnotesize
\begin{tabular}{@{}l l l l@{}}
\toprule
& \textbf{không thêm} & \textbf{ngẫu nhiên} & \textbf{RAR} \\
\midrule
$\varepsilon_{L^2}$ & $7{,}18\times10^{-4}$ & $8{,}22\times10^{-4}$
  & $\mathbf{6{,}48\times10^{-4}}$ \\
\quad khoảng ($\times10^{-4}$) & $[3{,}84;\ 13{,}2]$ & $[3{,}54;\ 15{,}8]$
  & $[3{,}85;\ 8{,}33]$ \\
\quad RAR thắng & $3/5$ & $4/5$ & --- \\
\addlinespace
$\max\abs{u_{\btheta} - u}$ & $9{,}75\times10^{-3}$ & $1{,}28\times10^{-2}$
  & $\mathbf{8{,}51\times10^{-3}}$ \\
\quad RAR thắng & $4/5$ & $4/5$ & --- \\
\addlinespace
\% bình phương sai số trong dải & $79\%$ & $84\%$ & $\mathbf{51\%}$ \\
sai số điển hình ngoài dải & $\mathbf{1{,}0\times10^{-4}}$ & $1{,}2\times10^{-4}$
  & $1{,}4\times10^{-4}$ \\
điểm thêm nằm trong dải & --- & $1\%$ & $24\%$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Images/chap_5/fig58_tn10b.pdf}
\caption[Tách biến RAR theo từng hạt giống]{Tách biến vai trò của RAR. Mỗi đường
nối ba nhánh của \emph{cùng} một hạt giống. (a) Với $\varepsilon_{L^2}$, các
đường cắt nhau: không nhánh nào thắng nhất quán. (b) Với sai số lớn nhất, RAR
thắng ở bốn trên năm hạt giống. (c) RAR kéo phần sai số nằm trong dải sốc từ
khoảng $80\%$ xuống khoảng $50\%$.}
\label{fig:tn10b}
\end{figure}

\textbf{Kết quả (a): trên sai số toàn cục, đóng góp của RAR nhỏ và không nhất
quán.} Trung vị $\varepsilon_{L^2}$ của RAR tốt hơn nhánh không thêm điểm
$1{,}11$ lần, nhưng xét theo từng hạt giống thì RAR chỉ thắng ba trên năm, với
tỉ số trải từ $0{,}66$ tới $1{,}86$ (Hình~\ref{fig:tn10b}(a)). Với $n = 5$, ba
trên năm không phân biệt được với may rủi. Ghép với
Bảng~\ref{tab:tn10-ketqua}, mức cải thiện $213$ lần của TN10 nay tách được
thành ba phần theo thang logarit: khoảng $83\%$ đến trước khi có điểm RAR nào
(mạng, $N_r$, đợt L-BFGS đầu), khoảng $15\%$ từ năm đợt L-BFGS tiếp theo
\emph{không cần} thêm điểm nào ($1{,}58\times10^{-3} \to 7{,}18\times10^{-4}$),
và chỉ khoảng $2\%$ còn lại có thể quy cho RAR. Nhánh RAR cũng không được lợi
thế nhờ tính toán nhiều hơn: nó dùng $16\,600$--$16\,800$ lần đánh giá hàm mục
tiêu, ít hơn hai nhánh kia ($17\,100$--$17\,400$).

\textbf{Kết quả (b): số lượng điểm không phải là yếu tố.} Thêm $1\,500$ điểm
ngẫu nhiên không tốt hơn không thêm gì --- nhánh không thêm thắng ba trên năm,
và trung vị của nó còn thấp hơn. Vậy nếu RAR có tác dụng thì tác dụng ấy đến từ
\emph{vị trí} điểm, không phải từ việc có thêm điểm.

\textbf{Kết quả (c): tác dụng thật của RAR là cục bộ, và có giá.} RAR đặt trung
vị $24\%$ số điểm mới vào dải sốc --- nơi chỉ chiếm $1{,}4\%$ diện tích, tức lấy
mẫu dày gấp khoảng $17$ lần --- và kết quả hiện đúng ở đó: sai số lớn nhất, vốn
luôn nằm trong dải, giảm ở bốn trên năm hạt giống; phần bình phương sai số trong
dải giảm từ khoảng $80\%$ xuống $51\%$. Nhưng sai số điển hình \emph{ngoài} dải
lại tăng nhẹ, từ $1{,}0\times10^{-4}$ lên $1{,}4\times10^{-4}$: dồn điểm vào lớp
sốc làm hàm mục tiêu ``chú ý'' ít hơn tới vùng trơn. Hai tác động gần như triệt
tiêu nhau trong $\varepsilon_{L^2}$, và đó chính là lý do Kết quả (a) nhỏ.

\begin{nhanxet}[RAR là công cụ cho sai số cục bộ, không cho sai số toàn cục]
\label{nx:rar-cuc-bo}
Hạn chế~(4) ở Mục~\ref{sec:hanche} dự báo RAR là ``kỹ thuật có khả năng cải
thiện rõ nhất'' cho Burgers. Tách biến cho thấy dự báo ấy chỉ đúng một nửa, và
đúng ở đại lượng khác với đại lượng mà báo cáo dùng để chấm điểm: RAR cải thiện
nhất quán \emph{sai số lớn nhất} tại lớp sốc, nhưng gần như không đổi
$\varepsilon_{L^2}$, vì cái được ở lớp sốc bị trả lại ở vùng trơn. Mức cải
thiện $213$ lần của TN10 vì vậy phải được quy cho cấu hình mạng, số điểm phối trí
và độ dài L-BFGS, không cho RAR.

Kết luận này có phạm vi hẹp: một lịch RAR duy nhất ($500$ điểm sau mỗi đợt
$1$--$3$), điểm cũ được giữ nguyên, và $n = 5$. Một dự đoán tự nhiên là các biến
thể lấy mẫu lại toàn bộ tập điểm theo phân phối tỉ lệ với $\abs{r}$, có giữ một
phần mật độ trên vùng trơn, sẽ tránh được sự đánh đổi ở Kết quả (c).
Mục~\ref{subsec:tn10-rad} kiểm dự đoán ấy, và nó sai.
\end{nhanxet}

\subsection{Lấy mẫu lại toàn bộ: kiểm dự đoán của Nhận xét~\ref{nx:rar-cuc-bo}}
\label{subsec:tn10-rad}

Nhận xét~\ref{nx:rar-cuc-bo} đưa ra một dự đoán cụ thể: sự đánh đổi giữa lớp
sốc và vùng trơn đến từ việc RAR \emph{thêm} điểm vào lớp sốc mà không giữ mật
độ ở nơi khác, nên một biến thể \emph{lấy mẫu lại toàn bộ} có giữ mật độ vùng
trơn sẽ tránh được nó. Mục này kiểm dự đoán ấy.

\textbf{Thiết kế.} Dùng phương pháp RAD của Wu và cộng sự~\cite{wu2023}: sau mỗi
đợt L-BFGS từ $1$ tới $5$, bỏ \emph{toàn bộ} $10\,000$ điểm phần dư và lấy lại
$10\,000$ điểm từ $100\,000$ ứng viên rải đều, với xác suất
\begin{equation}
p(\bx) \;\propto\; \frac{\abs{r(\bx)}^{k}}{\mathbb{E}\big[\abs{r}^{k}\big]} + c .
\label{eq:rad}
\end{equation}
Hạng $c$ giữ một phần khối lượng xác suất phân bố đều, tức giữ mật độ điểm trên
vùng trơn. Hai nhánh, rẽ từ \emph{cùng} trạng thái như
Mục~\ref{subsec:tn10-tachbien}: $k = 1$, $c = 1$ (giá trị mặc định mà Wu và cộng
sự khuyến nghị) và $k = 1$, $c = 0$ (tỉ lệ thuận $\abs{r}$, không giữ vùng
trơn). Số điểm luôn là $10\,000$, bằng nhánh không thêm điểm, nên so sánh cặp
với nhánh ấy là công bằng. Phần chung của cả năm hạt giống trùng
Mục~\ref{subsec:tn10-tachbien} từng bit.

\textbf{Ba giả thuyết, ghi trong mã nguồn trước khi chạy.}
(H1) RAD với $c = 1$ tốt hơn nhánh không thêm điểm về $\varepsilon_{L^2}$ ở ít
nhất bốn trên năm hạt giống.
(H2) RAD với $c = 1$ không làm vùng trơn tệ đi: trung vị sai số điển hình ngoài
dải không vượt $1{,}02\times10^{-4}$ của nhánh không thêm điểm.
(H3) Chính hạng $c$ là thứ bảo vệ vùng trơn: $c = 1$ tốt hơn $c = 0$ ở ngoài dải
ở ít nhất bốn trên năm hạt giống.

\begin{table}[H]
\centering
\caption[Bốn cách xử lý điểm phối trí]{Bốn cách xử lý điểm phối trí trên năm hạt
giống, rẽ từ cùng trạng thái sau đợt L-BFGS thứ nhất. Trung vị; khoảng ghi dưới
đơn vị $10^{-4}$. Hàng ``thắng'' đếm số hạt giống mà nhánh ấy tốt hơn nhánh
\emph{không thêm} trên cùng hạt giống.}
\label{tab:tn10c}
\footnotesize
\begin{tabular}{@{}l l l l l@{}}
\toprule
& \textbf{không thêm} & \textbf{RAR} & \textbf{RAD, $c = 0$}
  & \textbf{RAD, $c = 1$} \\
\midrule
$\varepsilon_{L^2}$ & $7{,}18\times10^{-4}$ & $6{,}48\times10^{-4}$
  & $8{,}21\times10^{-4}$ & $6{,}69\times10^{-4}$ \\
\quad khoảng ($\times10^{-4}$) & $[3{,}84;\ 13{,}2]$ & $[3{,}85;\ 8{,}33]$
  & $[4{,}49;\ 13{,}1]$ & $[3{,}05;\ 15{,}0]$ \\
\quad thắng & --- & $3/5$ & $3/5$ & $2/5$ \\
\addlinespace
sai số điển hình ngoài dải & $\mathbf{1{,}02\times10^{-4}}$ & $1{,}42\times10^{-4}$
  & $1{,}36\times10^{-4}$ & $1{,}16\times10^{-4}$ \\
\quad thắng & --- & $0/5$ & $0/5$ & $0/5$ \\
\addlinespace
$\max\abs{u_{\btheta} - u}$ & $9{,}75\times10^{-3}$ & $8{,}51\times10^{-3}$
  & $1{,}04\times10^{-2}$ & $8{,}91\times10^{-3}$ \\
\quad thắng & --- & $4/5$ & $3/5$ & $2/5$ \\
\addlinespace
điểm phối trí nằm trong dải & $1{,}4\%$ & $4{,}5\%$ & $4{,}1\%$ & $3{,}3\%$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Images/chap_5/fig59_tn10c.pdf}
\caption[Bốn cách xử lý điểm phối trí theo từng hạt giống]{Bốn cách xử lý điểm
phối trí; mỗi đường nối là một hạt giống. (a) Với $\varepsilon_{L^2}$, các
đường cắt nhau chằng chịt: không chiến lược nào thắng nhất quán. (b) Sai số điển
hình ngoài dải sốc: nhánh không thêm điểm thấp nhất ở \emph{mọi} hạt giống.
(c) Sai số lớn nhất.}
\label{fig:tn10c}
\end{figure}

\textbf{Kết quả: H1 không đạt, H2 không đạt, H3 đạt.}
RAD với $c = 1$ chỉ tốt hơn nhánh không thêm điểm ở hai trên năm hạt giống
(H1), và sai số vùng trơn của nó cao hơn nhánh ấy ở \emph{cả năm} hạt giống,
trung vị $1{,}16\times10^{-4}$ so với $1{,}02\times10^{-4}$ (H2). Hạng $c$ có
tác dụng đúng hướng --- $c = 1$ giữ vùng trơn tốt hơn $c = 0$ ở bốn trên năm hạt
giống (H3) --- nhưng chỉ \emph{giảm} thiệt hại, không xoá được nó. Dự đoán ở
Nhận xét~\ref{nx:rar-cuc-bo} vì vậy sai ở điểm chính.

Hai quan sát khác quan trọng hơn chính ba giả thuyết.

\emph{Thứ nhất, sự đánh đổi là quy luật chứ không phải đặc điểm của RAR.} Cả ba
chiến lược thích nghi --- RAR, RAD với $c = 0$, RAD với $c = 1$ --- đều cho sai
số vùng trơn cao hơn tập điểm cố định, ở \emph{mười lăm trên mười lăm} lần so
sánh cặp (Hình~\ref{fig:tn10c}(b)). Đây là kết quả nhất quán nhất của toàn bộ
chuỗi thí nghiệm lấy mẫu. Cách giải thích đơn giản nhất: với số điểm cố định,
mọi điểm dời vào lớp sốc là một điểm lấy khỏi vùng trơn, và ở mức sai số này
vùng trơn đóng góp khoảng một nửa $\varepsilon_{L^2}$ (Kết quả~3). Đáng chú ý là
cả ba chiến lược đều dời điểm rất nhẹ tay --- dải sốc chỉ nhận $3$--$5\%$ tổng số
điểm, so với $1{,}4\%$ khi rải đều --- vậy mà vùng trơn vẫn tệ đi ở mọi hạt giống.

\emph{Thứ hai, chiến lược lấy mẫu không phải yếu tố quyết định ở cấu hình này.}
Chiến lược tốt nhất về $\varepsilon_{L^2}$ đổi theo từng hạt giống: RAD $c = 0$
ở hạt giống $0$, không thêm điểm ở hạt giống $1$ và $3$, RAD $c = 1$ ở hạt giống
$2$, RAR ở hạt giống $4$. Trên cùng một hạt giống, bốn chiến lược chênh nhau
$1{,}4$--$2{,}6$ lần; trên cùng một chiến lược, năm hạt giống chênh nhau
$2{,}2$--$4{,}9$ lần. Hai độ phân tán cùng bậc, nên với $n = 5$ không thể xếp hạng
các chiến lược theo $\varepsilon_{L^2}$.

\begin{nhanxet}[Kết luận của chuỗi thí nghiệm lấy mẫu]
\label{nx:lay-mau}
Mục~\ref{sec:tn10} cùng hai mục con của nó cho một kết luận nhất quán: ở cấu hình đã đủ
mạnh --- mạng tám lớp ẩn, $10\,000$ điểm, L-BFGS dài --- cách đặt điểm phối trí là
yếu tố \emph{bậc hai}. Không chiến lược thích nghi nào trong ba chiến lược thử
nghiệm cải thiện nhất quán sai số toàn cục; cả ba đều trả giá ở vùng trơn; và
chỉ RAR dạng thêm điểm cải thiện nhất quán sai số lớn nhất tại lớp sốc. Ghi chú
ở Bảng~\ref{tab:remedies} rằng lấy mẫu thích nghi ``tập trung tài nguyên vào vùng
có cấu trúc dốc'' vì vậy cần được đọc hẹp: với ngân sách điểm cho trước, nó \emph{phân
phối lại} sai số giữa các vùng, chứ không làm giảm tổng sai số.

Phạm vi: một bài toán, một cấu hình, $n = 5$, và các tham số $k$, $c$, lịch lấy
mẫu lấy theo mặc định của tài liệu chứ không được dò. Kết luận này \emph{không}
bác bỏ các cải thiện mà Wu và cộng sự~\cite{wu2023} báo cáo: thiết lập của họ
khác ở số điểm phối trí, lịch lấy mẫu và ngân sách huấn luyện. Một giả thuyết
tương thích với cả hai là lợi ích của lấy mẫu thích nghi giảm dần khi số điểm
phối trí đã đủ lớn so với thang độ dài của nghiệm; kiểm giả thuyết ấy cần một
phép quét theo $N_r$.
\end{nhanxet}

%==============================================================================
\section{Thí nghiệm 11: bài toán ngược --- đặt PINN vào đúng động lực của nó}
\label{sec:tn11}
%==============================================================================

\begin{thinghiem}[Nhận dạng độ nhớt khi không biết điều kiện đầu và điều kiện
biên]
\label{tn:nguoc}
Mười thí nghiệm trước đều là bài toán thuận, đủ dữ liệu, nên cùng nằm ngoài ba
động lực mà Mục~\ref{subsec:gioi-han-co-dien} dùng để biện minh cho PINNs
(Nhận xét~\ref{nx:doc-tn9}). Thí nghiệm này đặt PINN vào đúng động lực thứ nhất
và thứ hai: tìm hai tham số $\zeta_1, \zeta_2$ của \eqref{eq:burgers-param} từ
các điểm đo rời rạc có nhiễu, \emph{không} được cho điều kiện đầu lẫn điều kiện
biên --- đúng thiết lập của Ví dụ~\ref{vd:burgers-inverse}. Và nó hỏi điều mà Ví
dụ ấy mới chỉ khẳng định: \emph{so với một phương pháp cổ điển được cho cùng
thông tin, PINN có thật sự hơn không?}
\end{thinghiem}

\textbf{Thiết lập.} Dữ liệu gồm $N_u = 2\,000$ điểm $(x, t)$ rút ngẫu nhiên,
không lặp, từ lưới $2\,049\times201$ của nghiệm tham chiếu ở Mục~\ref{sec:tn5};
giá trị đo là $u + \sigma\,\mathrm{std}(u)\,\xi$ với $\xi \sim \mathcal N(0, 1)$
và $\sigma \in \{0;\ 0{,}01\}$, cùng một tập điểm cho cả hai mức nhiễu. Cấu hình
PINN lấy đúng theo mã nguồn gốc của Raissi và cộng sự~\cite{raissi2019}, đã
được đối chiếu trực tiếp: mạng tám lớp ẩn hai mươi nơ-ron, $\zeta_1$ khởi tạo
bằng $0$, $\log\zeta_2$ khởi tạo bằng $-6$, và phần dư tính tại chính $2\,000$
điểm đo. Ba đối thủ dùng \emph{cùng} dữ liệu (Bảng~\ref{tab:tn11-doithu}).

\begin{table}[H]
\centering
\caption[Ba đối thủ của bài toán ngược]{Ba đối thủ của
Thí nghiệm~\ref{tn:nguoc}. B và C dùng chính lược đồ của nghiệm tham chiếu (sai
phân trung tâm dạng bảo toàn, Runge--Kutta bậc bốn tường minh) trên lưới thô
hơn: $N_x = 1\,023$ là cấu hình chính, $N_x = 511$ là cấu hình phụ.}
\label{tab:tn11-doithu}
\footnotesize
\begin{tabular}{@{}l l p{5.2cm} l@{}}
\toprule
\textbf{Đối thủ} & \textbf{Biết đầu/biên?} & \textbf{Ẩn số} & \textbf{Gradient} \\
\midrule
A: PINN & không & $3\,021$ trọng số mạng, $\zeta_1$, $\zeta_2$
  & vi phân tự động \\
C: liên hợp rời rạc & không & $\zeta_1$, $\zeta_2$, $u(x, 0)$ (spline $33$ nút),
  $u(\pm1, t)$ (hai spline $11$ nút): $57$ ẩn & liên hợp viết tay \\
B: cổ điển đủ thông tin & có & $\zeta_1$, $\zeta_2$ & liên hợp viết tay \\
\bottomrule
\end{tabular}
\end{table}

A tối ưu bằng $2\,000$ vòng Adam rồi tối đa năm đợt L-BFGS, mỗi đợt $2\,000$
vòng, như các mục trước. B và C tối ưu bằng L-BFGS-B, dừng theo tiêu chí hội tụ
chặt của mã gốc ($\mathrm{ftol}$ cỡ epsilon máy). Gradient của C theo cả $57$ ẩn
số lấy bằng một lượt quét xuôi và một lượt quét ngược liên hợp qua từng bước
Runge--Kutta; chi phí khoảng ba lần một lần giải thuận và không phụ thuộc số ẩn.
Bản cài đặt được đối chiếu với vi phân tự động của PyTorch và khớp tới
$10^{-16}$. Lược đồ tường minh còn buộc phải chặn trên $\zeta_2 \le 0{,}01$ để
chọn được bước thời gian ổn định --- một ràng buộc PINN không cần; trong $40$ lần
chạy cổ điển, chặn ấy chưa lần nào bị chạm và lược đồ chưa lần nào mất ổn định.

\textbf{Giả thuyết, ghi và commit trong mã nguồn trước khi chạy.}
(H1) PINN, dữ liệu sạch: sai số tương đối của $\zeta_2$ dưới $1\%$ ở cả năm hạt
giống. (H2) PINN, nhiễu $1\%$: dưới $5\%$ ở cả năm. (H3) Ví
dụ~\ref{vd:burgers-inverse} viết ``sai số của $\zeta_2$ \emph{luôn} lớn hơn sai
số của $\zeta_1$ \emph{khoảng một bậc}'': kiểm bằng
$\mathrm{err}(\zeta_2) > \mathrm{err}(\zeta_1)$ ở ít nhất chín trên mười lần chạy
PINN, và trung vị tỉ số nằm trong $[3;\ 30]$. (H4) Mục~\ref{subsec:thuan-nguoc}
gọi cách làm của PINN là ``ưu thế nổi bật so với các phương pháp bài toán ngược
cổ điển'': kiểm bằng so sánh cùng thông tin A với C ($N_x = 1\,023$) --- (H4a)
trung vị sai số $\zeta_2$ của PINN nhỏ hơn ở cả hai mức nhiễu; (H4b) trung vị
thời gian của PINN ngắn hơn ở cả hai mức nhiễu.

\begin{table}[H]
\centering
\caption[Kết quả bài toán ngược]{Kết quả của Thí nghiệm~\ref{tn:nguoc}, trung vị
trên năm hạt giống; khoảng $[\min;\max]$ của sai số $\zeta_2$ tính theo phần
trăm. Sai số trường là sai số $L^2$ tương đối của $u$ tái dựng trên toàn lưới
tham chiếu. Cột thời gian ghi hai con số: lúc $\zeta_2$ đã ổn định trong $\pm1\%$
quanh giá trị cuối, và lúc thuật toán dừng. Mỗi lần chạy dùng riêng một lõi
CPU. Công trình gốc~\cite{raissi2019} báo cáo một lần chạy: $0{,}09\%$ và
$0{,}12\%$ (sạch), $0{,}04\%$ và $0{,}84\%$ (nhiễu $1\%$).}
\label{tab:tn11}
\footnotesize
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}l l l l r@{}}
\toprule
\textbf{Đối thủ} & \textbf{sai số $\zeta_1$} & \textbf{sai số $\zeta_2$}
  & \textbf{sai số trường} & \textbf{giây: ổn định / dừng} \\
\midrule
\multicolumn{5}{@{}l}{\emph{dữ liệu sạch}} \\
PINN (A) & $0{,}013\%$ & $0{,}29\%$ $[0{,}025;\ 1{,}81]$ & $2{,}4\times10^{-3}$ & $109$ / $253$ \\
liên hợp, $N_x = 1\,023$ (C) & $0{,}006\%$ & $0{,}89\%$ $[0{,}60;\ 1{,}09]$ & $4{,}7\times10^{-4}$ & $43$ / $309$ \\
liên hợp, $N_x = 511$ (C) & $0{,}009\%$ & $4{,}36\%$ $[3{,}85;\ 4{,}81]$ & $1{,}7\times10^{-3}$ & $17$ / $128$ \\
biết đầu/biên, $N_x = 1\,023$ (B) & $0{,}003\%$ & $0{,}82\%$ $[0{,}62;\ 1{,}02]$ & $4{,}4\times10^{-4}$ & $17$ / $17$ \\
biết đầu/biên, $N_x = 511$ (B) & $0{,}010\%$ & $4{,}22\%$ $[3{,}85;\ 4{,}47]$ & $1{,}7\times10^{-3}$ & $7$ / $7$ \\
\addlinespace
\multicolumn{5}{@{}l}{\emph{nhiễu $1\%$}} \\
PINN (A) & $0{,}082\%$ & $0{,}49\%$ $[0{,}011;\ 1{,}11]$ & $2{,}3\times10^{-3}$ & $142$ / $257$ \\
liên hợp, $N_x = 1\,023$ (C) & $0{,}043\%$ & $0{,}38\%$ $[0{,}24;\ 0{,}73]$ & $2{,}9\times10^{-3}$ & $34$ / $1\,229$ \\
liên hợp, $N_x = 511$ (C) & $0{,}030\%$ & $4{,}04\%$ $[3{,}40;\ 4{,}37]$ & $3{,}4\times10^{-3}$ & $17$ / $487$ \\
biết đầu/biên, $N_x = 1\,023$ (B) & $0{,}027\%$ & $0{,}41\%$ $[0{,}26;\ 1{,}16]$ & $5{,}2\times10^{-4}$ & $9$ / $17$ \\
biết đầu/biên, $N_x = 511$ (B) & $0{,}016\%$ & $3{,}92\%$ $[3{,}13;\ 4{,}66]$ & $1{,}7\times10^{-3}$ & $7$ / $7$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Images/chap_5/fig510_tn11.pdf}
\caption[Bài toán ngược: PINN so với phương pháp liên hợp]{Thí
nghiệm~\ref{tn:nguoc}. (a), (b) Sai số tương đối của $\zeta_2$; mỗi chấm là một
hạt giống. Sai số của hai phương pháp cổ điển gần như chỉ phụ thuộc lưới: khoảng
$4\%$ ở $N_x = 511$ và dưới $1\%$ ở $N_x = 1\,023$, dù có biết điều kiện đầu và
biên hay không. (c) Thời gian: chấm đặc là lúc $\zeta_2$ đã ổn định, chấm rỗng
là lúc dừng. Phương pháp liên hợp có câu trả lời sớm hơn PINN, rồi dùng phần lớn
thời gian còn lại để khớp nhiễu vào $55$ hệ số của điều kiện đầu và biên.}
\label{fig:tn11}
\end{figure}

\textbf{Kết quả theo giả thuyết.}

\emph{H1 không đạt, H2 đạt.} PINN tìm được $\zeta_2$ với sai số trung vị
$0{,}29\%$ trên dữ liệu sạch và $0{,}49\%$ trên dữ liệu nhiễu, còn $\zeta_1$ gần
như chính xác ($0{,}013\%$ và $0{,}082\%$). Nhưng một trong năm hạt giống cho
$1{,}81\%$ trên dữ liệu sạch, nên H1 không đạt; bốn hạt giống còn lại đều dưới
$0{,}4\%$. Hai con số một lần chạy của công trình gốc, $0{,}12\%$ và $0{,}84\%$,
nằm gọn trong khoảng đo được ở đây: kết quả của Raissi và cộng sự \emph{tái lập
được}, và khoảng ấy cho biết một lần chạy đơn lẻ có thể rơi vào đâu.

\emph{H3 không đạt.} Tỉ số $\mathrm{err}(\zeta_2)/\mathrm{err}(\zeta_1)$ có trung
vị $24{,}5$ --- vậy ``khoảng một bậc'' là đúng \emph{về trung vị} --- nhưng chỉ
lớn hơn $1$ ở tám trên mười lần chạy; ở hai lần còn lại, $\zeta_1$ lại sai nhiều
hơn. Chữ ``luôn'' vì vậy sai. Đáng chú ý hơn: chính hai con số mà Ví
dụ~\ref{vd:burgers-inverse} dẫn ra để rút kết luận ấy, $0{,}09\%$ và $0{,}12\%$
trên dữ liệu sạch, chỉ chênh nhau $1{,}3$ lần. Kết luận đã được khái quát hoá từ
một cặp số, trong đó một số không ủng hộ nó.

\emph{H4a không đạt, H4b đạt --- nhưng H4b đo sai thứ.} Về độ chính xác, kết quả
chia đôi: trên dữ liệu sạch PINN chính xác hơn ($0{,}29\%$ so với $0{,}89\%$),
trên dữ liệu nhiễu thì phương pháp liên hợp chính xác hơn ($0{,}38\%$ so với
$0{,}49\%$) và ít phân tán hơn hẳn. Về thời gian, tiêu chí đã đăng ký --- thời
gian tới khi dừng --- cho PINN thắng ở cả hai mức nhiễu ($253$ so với $309$ giây,
$257$ so với $1\,229$ giây), nên H4b đạt. Nhưng Hình~\ref{fig:tn11}(c) cho thấy
tiêu chí ấy đo \emph{tiêu chí dừng} chứ không đo \emph{tốc độ tìm ra đáp số}:
$\zeta_2$ của phương pháp liên hợp đã ổn định sau $34$--$43$ giây, và phần lớn
thời gian còn lại là để khớp nhiễu vào hệ số của điều kiện đầu và biên với ngưỡng
dừng cỡ epsilon máy. Tính theo lúc $\zeta_2$ ổn định --- một phép đo thêm vào
\emph{sau} khi thấy số liệu, nên chỉ được đọc như mô tả --- phương pháp liên hợp
nhanh hơn PINN từ $2{,}5$ tới $4{,}2$ lần.

\textbf{Những gì bảng không nói.} Ba quan sát bổ sung giúp đọc kết quả cho đúng.

\emph{Sai số của phương pháp cổ điển là sai số lưới.} Ở cả hai mức nhiễu, sai số
$\zeta_2$ của B và C gần như trùng nhau, và giảm năm lần (dữ liệu sạch) tới mười
lần (dữ liệu nhiễu) khi lưới mịn gấp đôi; với dữ liệu sạch, hệ số năm phù hợp
với bậc hai của lược đồ. Có biết điều kiện đầu và biên hay không gần như
không ảnh hưởng tới độ chính xác; nó chỉ ảnh hưởng tới \emph{thời gian}: $17$
giây khi biết, so với $34$--$43$ giây tới khi $\zeta_2$ ổn định và vài trăm tới
vài nghìn giây tới khi dừng khi không biết. Làm mịn lưới thêm một lần nữa sẽ hạ
sai số cổ điển xuống dưới PINN, nhưng lưới $N_x = 2\,047$ chính là lưới sinh ra
dữ liệu --- một ``tội ác bài toán ngược'' (\emph{inverse crime}) mà thí nghiệm cố
ý tránh. Ở chiều ngược lại, phép so sánh vẫn hơi ưu ái phương pháp cổ điển, vì
dữ liệu được sinh bằng chính lược đồ ấy trên lưới mịn hơn.

\emph{PINN tái dựng trường nghiệm kém hơn, nhưng ổn định hơn.} Trên dữ liệu sạch,
sai số trường của PINN ($2{,}4\times10^{-3}$) lớn gấp năm lần của phương pháp
liên hợp ($4{,}7\times10^{-4}$). Trên dữ liệu nhiễu thì hai bên ngang nhau về
trung vị, nhưng một lần chạy liên hợp (hạt giống $3$) cho sai số trường
$4{,}4\times10^{-2}$ trong khi vẫn tìm đúng $\zeta_2$: với $55$ hệ số tự do cho
điều kiện đầu và biên, nó đã khớp cả nhiễu vào biên. PINN không có lần chạy nào
như vậy.

\emph{Cái giá thật của phương pháp cổ điển là công sức, không phải thời gian
chạy.} Hàm mục tiêu của PINN cho bài toán ngược dài bảy dòng mã, khác bài toán
thuận đúng ở hai tham số được thêm vào. Bộ máy liên hợp dài $133$ dòng mã, cần
thêm một bộ kiểm gradient để tin được, một chặn trên cho $\zeta_2$ vì ổn định, và
một cơ chế xử lý khi lược đồ nổ nghiệm --- tất cả đều phải viết lại nếu đổi
phương trình.

\begin{nhanxet}[Ưu thế của PINN trong bài toán ngược: rẻ để viết, không rẻ để
chạy]
\label{nx:doc-tn11}
Thí nghiệm~\ref{tn:nguoc} là lần duy nhất báo cáo đặt PINN vào đúng động lực của
nó và cho nó một đối thủ được cho cùng thông tin. Kết quả không ủng hộ cách nói
``ưu thế nổi bật'' ở Mục~\ref{subsec:thuan-nguoc}, cũng không ủng hộ lý do được
nêu ở đó. Cả hai phương pháp đều lặp: PINN đánh giá hàm mục tiêu khoảng
$13\,600$ lần, phương pháp liên hợp giải bài toán thuận và bài toán liên hợp vài
trăm tới vài nghìn lần. Khi đã có bộ máy liên hợp, phương pháp cổ điển đạt độ
chính xác cùng bậc --- tốt hơn trên dữ liệu nhiễu, kém hơn trên dữ liệu sạch vì
sai số lưới --- và có câu trả lời sớm hơn; khi biết đủ điều kiện, nó nhanh hơn
PINN từ sáu tới mười lăm lần, tuỳ tính tới lúc $\zeta_2$ ổn định hay tới lúc
dừng.

Ưu thế thật của PINN nằm ở chỗ khác, và đo được: nó cho một phương pháp bài toán
ngược \emph{gần như miễn phí về công sức} --- không rời rạc hoá, không bước thời
gian, không ràng buộc ổn định, không phải suy ra và kiểm chứng một bài toán liên
hợp --- và nó xử lý điều kiện đầu và biên khuyết mà không cần đổi một dòng nào.
Đó là ưu thế về \emph{chi phí xây dựng} phương pháp, không phải về chi phí tính
toán hay độ chính xác. Với một phương trình một chiều đã có sẵn bộ giải, ưu thế
ấy nhỏ; với một hệ phương trình mà việc viết bộ giải liên hợp tốn hàng tháng,
nó có thể quyết định.

Phạm vi: một phương trình, hai tham số, $N_u = 2\,000$, hai mức nhiễu, $n = 5$;
phương pháp cổ điển được cài đặt bởi chính người viết báo cáo, với các lựa chọn
(số nút spline, tiêu chí dừng) lấy theo mặc định hợp lý chứ không được dò. Kết
luận về tốc độ thuộc về bài toán một chiều, nơi một lần giải thuận chỉ tốn chưa
tới một giây; ở bài toán mà một lần giải thuận đã đắt, lợi thế có thể đảo chiều.
\end{nhanxet}
...
& \textbf{Ước lượng thấp}, cần sửa (Mục~\ref{sec:tn9}) \\[4pt]
Ví dụ~\ref{vd:burgers-inverse}
& sai số $\zeta_2$ \emph{luôn} lớn hơn sai số $\zeta_1$ khoảng một bậc
& $8/10$ lần chạy; trung vị tỉ số $24{,}5$; hai lần ngược lại
& \textbf{Cần siết lại}: ``thường'', không ``luôn'' (Mục~\ref{sec:tn11}) \\[4pt]
Mục~\ref{subsec:thuan-nguoc}
& ưu thế nổi bật so với phương pháp bài toán ngược cổ điển
& cùng thông tin: PINN chính xác hơn trên dữ liệu sạch, kém hơn trên dữ liệu
  nhiễu, chậm hơn $2{,}5$--$4{,}2$ lần tới khi $\zeta_2$ ổn định
& \textbf{Cần siết lại}: ưu thế ở công sức xây dựng, không ở tính toán
  (Nhận xét~\ref{nx:doc-tn11})
\end{longtable}
\endgroup
 
Trong mười sáu hạng mục: sáu khớp trọn vẹn, hai khớp về hướng nhưng không về độ
lớn, \emph{sáu} cần siết lại cách phát biểu, một không tái lập được trên năm hạt
...
\emph{có điều kiện}, và điều kiện ấy hiện ra rất rõ khi xếp mười sáu hạng mục
theo \emph{nguồn gốc} của phát biểu thay vì theo kết quả.

Trong mười sáu hạng mục, \emph{sáu} là mệnh đề đã được chứng minh trong báo cáo
và \emph{mười} thì không. Ranh giới giữa hai nhóm ấy giải thích gần như toàn bộ
bảng.
...
\emph{Nhóm thứ hai --- mười hạng mục không phải mệnh đề --- thì phân hoá.} Hai
...
Bổ đề~\ref{bd:phan-hoi-duong}. \emph{Bảy} hạng mục còn lại phải điều chỉnh.

Cộng cả hai nhóm: \emph{chín hạng mục} phải điều chỉnh --- hai cách đọc mệnh đề
và bảy phát biểu không phải mệnh đề. Trong toàn bộ chương thực nghiệm, chứng
minh chưa một lần thất bại; chỉ có suy đoán thất bại.

Chín hạng mục ấy mang \emph{mười} khiếm khuyết, vì giả thuyết
\eqref{eq:pho-hieu-dung} mắc cả hai kiểu cùng lúc. Mười khiếm khuyết chia thành
...
\eqref{eq:pho-hieu-dung}. Câu ``sai số của $\zeta_2$ luôn lớn hơn sai số của
$\zeta_1$ khoảng một bậc'' ở Ví dụ~\ref{vd:burgers-inverse} cũng thuộc kiểu này,
ở dạng cực đoan hơn: nó được rút từ một cặp số của một lần chạy, mà một trong hai
số không ủng hộ nó (Mục~\ref{sec:tn11}).

\emph{(iv) Phát biểu định lượng hay so sánh chưa từng được đo}: Nhận
xét~\ref{nx:chi-phi-bac-cao} đoán bội số $4$--$6$ trong khi đo được khoảng $9$
(Mục~\ref{sec:tn9}); và Mục~\ref{subsec:thuan-nguoc} gọi PINN là có ``ưu thế nổi
bật'' so với phương pháp cổ điển mà chưa từng đặt hai phương pháp cạnh nhau
(Mục~\ref{sec:tn11}).

Đáng chú ý là cả bốn kiểu đều \emph{không} bị phát hiện bởi một lần chạy. Ba
kiểu đầu cần nhiều hạt giống; kiểu thứ tư cần một phép đo --- lặp phép đo thời
gian, hoặc dựng một đối thủ. Không kiểu nào đòi hỏi thêm lý thuyết.
...
\item \emph{Khảo sát độ nhạy theo cách lấy mẫu còn hẹp.} Lấy mẫu siêu khối Latin
ở Bảng~\ref{tab:remedies} chưa được thử. Lấy mẫu thích nghi RAR đã được đo riêng
bằng thí nghiệm tách biến ở Mục~\ref{subsec:tn10-tachbien}, và kết quả trái với
dự báo ban đầu của chính mục này: RAR \emph{không} phải kỹ thuật cải thiện rõ
nhất cho $\varepsilon_{L^2}$ --- đóng góp của nó nhỏ và không nhất quán --- mà
là công cụ cho sai số \emph{cục bộ} tại lớp sốc
(Nhận xét~\ref{nx:rar-cuc-bo}). Biến thể lấy mẫu lại toàn bộ (RAD) cũng đã được
đo ở Mục~\ref{subsec:tn10-rad} và không cải thiện được điều đó. Hạn chế còn lại
là các tham số $k$, $c$ và lịch lấy mẫu chưa được dò, và chưa có phép quét theo
$N_r$ để biết lợi ích của lấy mẫu thích nghi phụ thuộc số điểm ra sao.
...
\item \emph{Chỉ một trong ba động lực của Mục~\ref{subsec:gioi-han-co-dien}
được thực nghiệm, và ở dạng hẹp.} Mười thí nghiệm đầu đều là bài toán
\emph{thuận}, một chiều theo không gian, với dữ liệu biên và dữ liệu đầu cho
đầy đủ và không nhiễu --- đúng chế độ mà phương pháp lưới cổ điển gần như tối
ưu, và Mục~\ref{sec:tn9} đo được cái giá của việc đó: chậm hơn khoảng
$1{,}8\times10^{4}$ lần ở cùng mức sai số. Các thí nghiệm ấy kiểm chứng \emph{cơ
chế} của PINNs --- vai trò hàm kích hoạt, cái giá của ràng buộc mềm, thiên kiến
phổ, bệnh lý gradient, các chặn ổn định --- chứ không kiểm chứng \emph{tính cạnh
tranh} của phương pháp. Mục~\ref{sec:tn11} lấp một phần khoảng trống: một bài
toán ngược với điều kiện đầu và biên khuyết, đặt cạnh một đối thủ cổ điển cùng
thông tin. Nhưng đó là một phương trình, hai tham số và một chiều không gian;
động lực thứ ba --- lời nguyền số chiều --- vẫn hoàn toàn chưa được chạm tới.
\end{enumerate}
...
kết quả tiêu cực. Thí nghiệm tách biến cho thấy lấy mẫu thích nghi --- biện pháp
mà báo cáo kỳ vọng nhiều nhất --- chỉ đóng góp khoảng $2\%$ (thang logarit) của
mức cải thiện, và không nhất quán giữa các hạt giống; tác dụng thật của nó là
cục bộ tại lớp sốc (Nhận xét~\ref{nx:rar-cuc-bo}). Biến thể lấy mẫu lại toàn bộ
cũng không khá hơn, và cả ba chiến lược thích nghi đều làm vùng trơn tệ đi ở
mười lăm trên mười lăm lần so sánh (Nhận xét~\ref{nx:lay-mau}). Và kết quả ấy chỉ thu hẹp
khoảng cách chi phí $1{,}6$ lần --- vẫn bốn bậc độ lớn.

Mục~\ref{sec:tn11} là lần duy nhất chương này đặt PINN vào đúng động lực của nó:
một bài toán ngược không có điều kiện đầu và biên, cạnh một đối thủ cổ điển được
cho cùng thông tin. PINN tìm được độ nhớt với sai số trung vị $0{,}29\%$ (dữ liệu
sạch) và $0{,}49\%$ (nhiễu $1\%$), tái lập được kết quả của công trình gốc. Nhưng
phương pháp liên hợp rời rạc đạt độ chính xác cùng bậc và có câu trả lời sớm hơn
$2{,}5$ tới $4{,}2$ lần; ưu thế của PINN hoá ra nằm ở công sức xây dựng phương pháp
--- bảy dòng mã so với $133$ --- chứ không ở chi phí tính toán
(Nhận xét~\ref{nx:doc-tn11}). Thí nghiệm này cũng buộc phải siết lại hai phát biểu
của Chương~\ref{chap:pinn}.

Các kết quả cuối cùng ấy minh hoạ đúng vai trò của chương: bước kiểm chứng số không
