...
$1$--$3$), điểm cũ được giữ nguyên, và $n = 5$. Các biến thể lấy mẫu lại toàn bộ
tập điểm theo phân phối tỉ lệ với $\abs{r}$ --- vốn giữ được mật độ điểm trên
vùng trơn --- có thể tránh được sự đánh đổi ở Kết quả (c), và chưa được thử.
\end{nhanxet}
...
(Nhận xét~\ref{nx:rar-cuc-bo}). Hạn chế còn lại là chỉ một lịch RAR được thử;
các biến thể lấy mẫu lại toàn bộ theo $\abs{r}$ chưa được đo.
...
cục bộ tại lớp sốc (Nhận xét~\ref{nx:rar-cuc-bo}). Và kết quả ấy chỉ thu hẹp
