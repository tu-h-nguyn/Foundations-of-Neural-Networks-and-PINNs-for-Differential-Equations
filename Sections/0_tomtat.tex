...
đến gần như hoàn toàn từ cấu hình mạng và tối ưu hoá, còn lấy mẫu thích nghi chỉ
cải thiện sai số cục bộ tại lớp sốc.
...
comes almost entirely from the network and optimiser configuration; adaptive
sampling only improves the local error at the shock.
