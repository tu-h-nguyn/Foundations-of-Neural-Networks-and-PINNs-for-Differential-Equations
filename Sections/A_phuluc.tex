...
\texttt{pinns/exp10c\_rad.py} & Mục~\ref{sec:tn10}, biến thể lấy mẫu lại toàn
  ...
  \texttt{exp10b} \\
\texttt{pinns/exp11\_nguoc.py} & Mục~\ref{sec:tn11}, bài toán ngược: PINN và hai
  đối thủ cổ điển trên cùng dữ liệu; giả thuyết ghi ở đầu tệp trước khi chạy \\
\texttt{pinns/lienhop\_burgers.py} & Bộ giải sai phân với điều kiện đầu và biên là
  ẩn số, gradient bằng phương pháp liên hợp rời rạc viết tay; tự kiểm khớp vi phân
  tự động tới $10^{-16}$ khi chạy trực tiếp \\
\texttt{pinns/animate.py} & Hoạt hình quá trình huấn luyện (TN1, TN3, TN10,
  TN11) ra GIF và PDF nhiều trang cho slide, cùng
  Hình~\ref{fig:tn10}, \ref{fig:tn10b}, \ref{fig:tn10c} và \ref{fig:tn11} \\
\texttt{pinns/run\_all.py} & Chạy lần lượt cả mười một thí nghiệm \\
